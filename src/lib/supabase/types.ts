...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      get_secretary_dashboard_stats: { Args: never; Returns: Json }
...
//   tipo_conteudo: text (nullable, default: 'link'::text)
...
// Table: documentos_parceiros
//   PRIMARY KEY documentos_parceiros_pkey: PRIMARY KEY (id)
// Table: due_diligence
...
// Table: instituicoes_parceiras
//   PRIMARY KEY instituicoes_parceiras_pkey: PRIMARY KEY (id)
// Table: investigacoes
...
//   CHECK usuarios_escola_perfil_check: CHECK ((perfil = ANY (ARRAY['publico_externo'::text, 'colaborador'::text, 'professor'::text, 'senior'::text, 'operacional'::text, 'SECRETARIA DE EDUCAÇÃO'::text, 'gestao_escola'::text, 'ANALISTA_COMPLIANCE'::text, 'DIRETOR_COMPLIANCE'::text, 'administrador'::text, 'admin_gestor'::text])))
...
//     USING: true
//   Policy "director_update_config" (ALL, PERMISSIVE) roles={authenticated}
//     USING: (key = ANY (ARRAY['secretary_dashboard_config'::text, 'secretary_share_app_config'::text]))
//     WITH CHECK: (key = ANY (ARRAY['secretary_dashboard_config'::text, 'secretary_share_app_config'::text]))
//   Policy "secretary_read_config" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: (key = ANY (ARRAY['secretary_dashboard_config'::text, 'secretary_share_app_config'::text]))
//   Policy "secretary_specific_read_share_config" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: ((key = 'secretary_share_app_config'::text) AND (EXISTS ( SELECT 1    FROM usuarios_escola   WHERE ((usuarios_escola.id = auth.uid()) AND (usuarios_escola.perfil = 'SECRETARIA DE EDUCAÇÃO'::text)))))
// Table: analyst_assignments
...
//   Policy "Senior and Admin manage assignments" (ALL, PERMISSIVE) roles={authenticated}
//     USING: (is_senior_or_admin() OR check_is_admin_master())
// Table: audit_findings
...
//   Policy "Compliance view all audits" (SELECT, PERMISSIVE) roles={authenticated}
...
//   Policy "Senior can view all auditorias" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: (EXISTS ( SELECT 1    FROM usuarios_escola ue   WHERE ((ue.id = auth.uid()) AND (ue.perfil = 'senior'::text))))
//   Policy "Senior global read auditorias" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: (EXISTS ( SELECT 1    FROM usuarios_escola ue   WHERE ((ue.id = auth.uid()) AND (ue.perfil = 'senior'::text))))
...
//     USING: (EXISTS ( SELECT 1    FROM usuarios_escola   WHERE ((usuarios_escola.id = auth.uid()) AND (usuarios_escola.perfil = 'DIRETOR_COMPLIANCE'::text))))
//   Policy "Senior and Admin view all evidences" (ALL, PERMISSIVE) roles={authenticated}
//     USING: (is_senior_or_admin() OR check_is_admin_master())
// Table: compliance_tasks
...
//   Policy "Senior and Admin Manage Tasks" (ALL, PERMISSIVE) roles={authenticated}
//     USING: (is_senior_or_admin() OR check_is_admin_master())
// Table: compliance_workflow_logs
...
//   Policy "Senior can view all controles" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: (EXISTS ( SELECT 1    FROM usuarios_escola ue   WHERE ((ue.id = auth.uid()) AND (ue.perfil = 'senior'::text))))
//   Policy "Senior global read controles" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: (EXISTS ( SELECT 1    FROM usuarios_escola ue   WHERE ((ue.id = auth.uid()) AND (ue.perfil = 'senior'::text))))
// Table: denuncias
...
//     USING: (EXISTS ( SELECT 1    FROM usuarios_escola ue   WHERE ((ue.id = auth.uid()) AND ((ue.perfil = 'senior'::text) OR ((ue.perfil = ANY (ARRAY['administrador'::text, 'admin_gestor'::text])) AND ((ue.escola_id IS NULL) OR (ue.escola_id = denuncias.escola_id)))))))
//   Policy "Senior global read denuncias" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: (EXISTS ( SELECT 1    FROM usuarios_escola ue   WHERE ((ue.id = auth.uid()) AND (ue.perfil = 'senior'::text))))
//   Policy "Users can view their own complaints" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: (user_id = auth.uid())
//   Policy "gestor_view_school_complaints" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: (EXISTS ( SELECT 1    FROM usuarios_escola ue   WHERE ((ue.id = auth.uid()) AND (ue.perfil = 'gestao_escola'::text) AND (ue.escola_id = denuncias.escola_id))))
...
//     WITH CHECK: (((anonimo IS TRUE) OR ((denunciante_id IS NULL) AND (user_id IS NULL))) AND (protocolo IS NOT NULL) AND (denunciante_nome IS NULL) AND (denunciante_email IS NULL) AND (denunciante_telefone IS NULL))
// Table: documentos_parceiros
//   Policy "Admin write documentos_parceiros" (ALL, PERMISSIVE) roles={authenticated}
...
//   Policy "Public read documentos_parceiros" (SELECT, PERMISSIVE) roles={public}
//     USING: (ativo = true)
// Table: due_diligence
...
//     USING: is_user_member_of_escola(id)
...
//     USING: ((ativo = true) OR is_user_member_of_escola(id) OR check_is_admin_master() OR is_compliance_director())
...
//     USING: (is_compliance_director() OR is_user_member_of_escola(id))
//     WITH CHECK: (is_compliance_director() OR is_user_member_of_escola(id))
...
// Table: instituicoes_parceiras
//   Policy "Admin write parceiros" (ALL, PERMISSIVE) roles={authenticated}
//     USING: (EXISTS ( SELECT 1    FROM usuarios_escola ue   WHERE ((ue.id = auth.uid()) AND (ue.perfil = ANY (ARRAY['senior'::text, 'administrador'::text, 'admin_gestor'::text])))))
//   Policy "Public read parceiros" (SELECT, PERMISSIVE) roles={public}
//     USING: (ativo = true)
// Table: investigacoes
...
//     USING: check_is_operational()
//   Policy "Senior can view all investigacoes" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: (EXISTS ( SELECT 1    FROM usuarios_escola ue   WHERE ((ue.id = auth.uid()) AND (ue.perfil = 'senior'::text))))
//   Policy "Senior global read investigacoes" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: (EXISTS ( SELECT 1    FROM usuarios_escola ue   WHERE ((ue.id = auth.uid()) AND (ue.perfil = 'senior'::text))))
// Table: logs_sistema
...
//     USING: (EXISTS ( SELECT 1    FROM usuarios_escola   WHERE ((usuarios_escola.id = auth.uid()) AND (usuarios_escola.perfil = ANY (ARRAY['DIRETOR DE COMPLIANCE'::text, 'analista_de_compliance'::text])) AND (usuarios_escola.ativo = true))))
//   Policy "Senior can view all matriz_riscos" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: (EXISTS ( SELECT 1    FROM usuarios_escola ue   WHERE ((ue.id = auth.uid()) AND (ue.perfil = 'senior'::text))))
//   Policy "Senior global read matriz_riscos" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: (EXISTS ( SELECT 1    FROM usuarios_escola ue   WHERE ((ue.id = auth.uid()) AND (ue.perfil = 'senior'::text))))
// Table: mediacoes
...
//     USING: check_is_operational()
//   Policy "Senior can view all mediations" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: (EXISTS ( SELECT 1    FROM usuarios_escola ue   WHERE ((ue.id = auth.uid()) AND (ue.perfil = 'senior'::text))))
//   Policy "Senior global read mediacoes" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: (EXISTS ( SELECT 1    FROM usuarios_escola ue   WHERE ((ue.id = auth.uid()) AND (ue.perfil = 'senior'::text))))
...
//     USING: (EXISTS ( SELECT 1    FROM usuarios_escola ue   WHERE ((ue.id = auth.uid()) AND (ue.perfil = ANY (ARRAY['DIRETOR_COMPLIANCE'::text, 'ANALISTA_COMPLIANCE'::text, 'senior'::text, 'administrador'::text, 'admin_gestor'::text])))))
//     WITH CHECK: (EXISTS ( SELECT 1    FROM usuarios_escola ue   WHERE ((ue.id = auth.uid()) AND (ue.perfil = ANY (ARRAY['DIRETOR_COMPLIANCE'::text, 'ANALISTA_COMPLIANCE'::text, 'senior'::text, 'administrador'::text, 'admin_gestor'::text])))))
//   Policy "Senior can view all processos" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: (EXISTS ( SELECT 1    FROM usuarios_escola ue   WHERE ((ue.id = auth.uid()) AND (ue.perfil = 'senior'::text))))
//   Policy "Senior global read processos" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: (EXISTS ( SELECT 1    FROM usuarios_escola ue   WHERE ((ue.id = auth.uid()) AND (ue.perfil = 'senior'::text))))
//   Policy "Users can view their school disciplinary processes" (SELECT, PERMISSIVE) roles={public}
//     USING: ((escola_id IN ( SELECT usuarios_escola.escola_id    FROM usuarios_escola   WHERE (usuarios_escola.id = auth.uid()))) OR ( SELECT check_is_admin_master() AS check_is_admin_master))
//   Policy "global_read_processos_disciplinares" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: (check_is_admin_master() OR (EXISTS ( SELECT 1    FROM usuarios_escola ue   WHERE ((ue.id = auth.uid()) AND (ue.perfil = ANY (ARRAY['senior'::text, 'administrador'::text, 'admin_gestor'::text, 'SECRETARIA DE EDUCAÇÃO'::text]))))))
// Table: relatorios_consolidados
...
//     USING: true
// Table: relatorios_ia
//   Policy "Permitir delete de relatorios_ia" (DELETE, PERMISSIVE) roles={authenticated}
//     USING: (check_is_admin_master() OR (EXISTS ( SELECT 1    FROM usuarios_escola   WHERE ((usuarios_escola.id = auth.uid()) AND (usuarios_escola.perfil = ANY (ARRAY['senior'::text, 'administrador'::text, 'admin_gestor'::text]))))))
//   Policy "Permitir inserção de relatorios_ia" (INSERT, PERMISSIVE) roles={authenticated}
//     WITH CHECK: ((escola_id IN ( SELECT usuarios_escola.escola_id    FROM usuarios_escola   WHERE (usuarios_escola.id = auth.uid()))) OR check_is_admin_master() OR (EXISTS ( SELECT 1    FROM usuarios_escola   WHERE ((usuarios_escola.id = auth.uid()) AND (usuarios_escola.perfil = ANY (ARRAY['senior'::text, 'administrador'::text, 'admin_gestor'::text, 'DIRETOR_COMPLIANCE'::text, 'ANALISTA_COMPLIANCE'::text]))))))
//   Policy "Permitir leitura global de relatorios_ia" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: (check_is_admin_master() OR (EXISTS ( SELECT 1    FROM usuarios_escola   WHERE ((usuarios_escola.id = auth.uid()) AND (usuarios_escola.perfil = ANY (ARRAY['senior'::text, 'administrador'::text, 'admin_gestor'::text, 'DIRETOR_COMPLIANCE'::text, 'ANALISTA_COMPLIANCE'::text]))))))
//   Policy "Permitir update de relatorios_ia" (UPDATE, PERMISSIVE) roles={authenticated}
//     USING: ((escola_id IN ( SELECT usuarios_escola.escola_id    FROM usuarios_escola   WHERE (usuarios_escola.id = auth.uid()))) OR check_is_admin_master() OR (EXISTS ( SELECT 1    FROM usuarios_escola   WHERE ((usuarios_escola.id = auth.uid()) AND (usuarios_escola.perfil = ANY (ARRAY['senior'::text, 'administrador'::text, 'admin_gestor'::text, 'DIRETOR_COMPLIANCE'::text, 'ANALISTA_COMPLIANCE'::text]))))))
...
//     USING: check_is_operational()
//   Policy "Senior Global Read Treinamentos" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: (EXISTS ( SELECT 1    FROM usuarios_escola ue   WHERE ((ue.id = auth.uid()) AND (ue.perfil = 'senior'::text))))
...
//     USING: check_is_operational()
//   Policy "Senior Global Read Treinamentos Conclusoes" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: (EXISTS ( SELECT 1    FROM usuarios_escola ue   WHERE ((ue.id = auth.uid()) AND (ue.perfil = 'senior'::text))))
...
//     USING: (auth.uid() = id)
// Table: usuarios_escola
//   Policy "Admin Master Full Access Users" (ALL, PERMISSIVE) roles={authenticated}
//     USING: check_is_admin_master()
//     WITH CHECK: check_is_admin_master()
...
//     USING: (id = auth.uid())
//   Policy "Senior Global View Users" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: is_senior_or_admin()
...
//     USING: ((id = auth.uid()) OR ((auth.jwt() ->> 'role'::text) = 'admin'::text) OR check_is_admin_master())
//     WITH CHECK: ((id = auth.uid()) OR ((auth.jwt() ->> 'role'::text) = 'admin'::text) OR check_is_admin_master())
// Table: workflow_analistas
...
//   $function$
//   
// FUNCTION get_secretary_dashboard_stats()
...
// Table: compliance_workflow_logs
//   CREATE INDEX idx_compliance_workflow_logs_complaint_id ON public.compliance_workflow_logs USING btree (complaint_id)
// Table: compromisso_alta_gestao
...
//   CREATE INDEX idx_denuncias_envolvidos_detalhes ON public.denuncias USING gin (envolvidos_detalhes)
